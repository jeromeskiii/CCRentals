      ...
      <div className="container mx-auto px-6 relative">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-sm font-bold tracking-widest text-sky-400 uppercase mb-4">
              Host Success
            </h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {reviews.map((rev, idx) => (
            <div
              key={idx}
              className="testimonial-card bg-zinc-900 border border-zinc-800 p-8 rounded-3xl hover:border-zinc-700 transition-colors"
            >
              ...
              <p className="text-lg text-zinc-300 leading-relaxed mb-8">"{rev.text}"</p>
              <div className="flex items-center gap-4">
                <img
                  src={rev.avatar}
