      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-muted-foreground">
            Don't just take our word for it. Hear from the property managers and hosts who trust us
        ...
        >
          {stats.map((stat, idx) => (
            <motion.div key={idx} variants={statVariants} className="text-center">
          ...
          {reviews.map((review) => (
            <motion.div
              ...
              className={`relative bg-card border rounded-2xl p-6 sm:p-8 hover:shadow-2xl transition-all duration-300 ${
                review.accent ? 'border-primary/30 shadow-lg shadow-primary/5' : 'border-border'
              }`}
            >
              {/* Rating */}
