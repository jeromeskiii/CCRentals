...
const rentalInventory = {
  ...
  equipment: [
    ...
    {
      name: 'Temporary Chainlink Fencing',
      description: 'Secure site perimeter for construction and events',
    },
    {
      name: 'Premium Privacy Fence',
      description: 'Attractive screening for events and sensitive areas',
    },
  ],
};
...
const serviceLines = [
  ...
  },
  {
    ...
    features: [
      ...
      'Weddings (luxury trailers)',
      'Agriculture (GAP-compliant)',
      'Disaster Relief',
    ],
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-muted-foreground">
            From premium portable toilets to full-service luxury trailers, backed by
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8 sm:mb-10">
            ...
            <p className="text-sm sm:text-base text-muted-foreground">
              Explore our complete lineup of sanitation solutions
            </p>
          </div>
