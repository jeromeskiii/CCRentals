  ...
  return (
    <section id="trust-signals" className="py-16 sm:py-20 md:py-24 bg-secondary/30">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        >
          <h2 className="text-xs sm:text-sm font-bold tracking-widest text-primary uppercase mb-3 sm:mb-4">Why Choose Us</h2>
          ...
          <p className="text-base sm:text-lg text-muted-foreground">
            We hold ourselves to the highest standards because your project's success depends on reliable sanitation solutions.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 mb-4 sm:mb-6">
              ...
              <span className="text-xs font-bold text-primary uppercase tracking-wider">Quality</span>
            </div>
            <div className="space-y-4 sm:space-y-6">
          ...
          >
            <div className="flex items-center gap-2 mb-4 sm:mb-6">
              ...
              <span className="text-xs font-bold text-primary uppercase tracking-wider">Volume</span>
            </div>
            <div className="space-y-4 sm:space-y-6">
          ...
          >
            <div>
              <div className="flex items-center gap-2 mb-3 sm:mb-4">
                ...
                <span className="text-xs font-bold uppercase tracking-wider opacity-80">Verified</span>
              </div>
