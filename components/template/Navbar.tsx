    ...
    >
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between">
          ...
          <div
            className={
              'hidden lg:flex items-center gap-8 text-sm font-semibold ' +
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className={
                'hidden sm:flex items-center gap-2 text-sm font-bold ' +
                (isScrolled ? 'text-foreground' : 'text-white')
              }
            >
              <svg
                className={'w-4 h-4 ' + (isScrolled ? 'text-primary' : 'text-white/80')}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
                aria-hidden="true"
            ...
            <button
              ...
              className={
                'px-6 py-2.5 text-sm font-bold rounded-full transition-all shadow-lg ' +
                (isScrolled
            ...
            <button
              ...
              className={
                'lg:hidden p-2 rounded-lg ' + (isScrolled ? 'text-foreground' : 'text-white')
              }
