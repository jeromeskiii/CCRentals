          ...
          >
            <div className="p-8">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 id={titleId} className="text-2xl font-black text-zinc-900">
                    Request Service
                  </h3>
              ...
              {isSuccess ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label
                      htmlFor={nameId}
                      className="block text-xs font-bold uppercase text-zinc-500 mb-1"
                    >
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-zinc-50 border rounded-xl focus:ring-2 focus:border-transparent outline-none transition-all ${
                        fieldErrors.name
                          ...
                          : 'border-zinc-200 focus:ring-sky-500'
                      }`}
                  ...
                  <p className="text-xs text-center text-zinc-400 mt-4">We respect your privacy.</p>
                </form>
              )}
            </div>
          </motion.div>
