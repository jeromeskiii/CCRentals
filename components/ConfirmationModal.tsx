        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            <div className="p-8">
              {/* Icon */}
              <div
                className={`w-16 h-16 ${styles.bg} rounded-2xl flex items-center justify-center text-3xl mb-6`}
              >
                {styles.icon}
              </div>

              {/* Content */}
              <h3 id={titleId} className="text-2xl font-black text-foreground mb-3">
                {title}
              </h3>
