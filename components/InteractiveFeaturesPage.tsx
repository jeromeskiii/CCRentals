...
const InteractiveFeaturesPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'calculator' | 'comparison' | 'calendar'>(
    'calculator'
  );
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto">
              Use our interactive tools to calculate quotes, compare services, and book your rental
              dates—all in real-time.
            </p>
