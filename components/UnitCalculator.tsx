...
const UnitCalculator: React.FC = () => {
  ...
  const recommendations: Recommendation[] = useMemo(() => {
    ...
    // Time multiplier
    const timeHours =
      durationUnit === 'days' ? duration * BUSINESS_RULES.unitCalculation.hoursPerDay : duration;
    if (timeHours > BUSINESS_RULES.unitCalculation.baseEventHours) {
      baseUnits = Math.ceil(
        baseUnits * (timeHours / BUSINESS_RULES.unitCalculation.baseEventHours)
      );
    }
    ...
    <section id="calculator" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-sky-600 font-bold uppercase tracking-widest text-sm mb-4">
            Planning Tool
          </h2>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                      {eventTypeOptions.map((option) => (
                        ...
                        >
                          ...
                          <span
                            className={`font-bold ${eventType === option.value ? 'text-sky-700' : 'text-zinc-900'}`}
                          >
                            {option.label}
                          </span>
                        </button>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                        ...
                        >
                          <div
                            className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl ${
                              alcoholServed ? 'bg-sky-500' : 'bg-zinc-100'
                            }`}
                          >
                            🍺
                          </div>
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-zinc-500">
                              Increases unit recommendations by ~20%
                            </p>
                          </div>
                          <div
                            className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                              alcoholServed ? 'border-sky-500 bg-sky-500' : 'border-zinc-300'
                            }`}
                          >
                            {alcoholServed && (
                              <svg
                      ...
                      >
                        <div
                          className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl ${
                            adaRequired ? 'bg-sky-500' : 'bg-zinc-100'
                          }`}
                        >
                          ♿
                        </div>
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-zinc-500">
                            Includes wheelchair-accessible units
                          </p>
                        </div>
                        <div
                          className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                            adaRequired ? 'border-sky-500 bg-sky-500' : 'border-zinc-300'
                          }`}
                        >
                          {adaRequired && (
                            <svg
                      ...
                      {(eventType === 'wedding' || eventType === 'corporate') && (
                        ...
                        >
                          <div
                            className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl ${
                              premiumPreferred ? 'bg-sky-500' : 'bg-zinc-100'
                            }`}
                          >
                            ✨
                          </div>
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-zinc-500">
                              Climate-controlled trailers with flushing toilets
                            </p>
                          </div>
                          <div
                            className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                              premiumPreferred ? 'border-sky-500 bg-sky-500' : 'border-zinc-300'
                            }`}
                          >
                            {premiumPreferred && (
                              <svg
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        <div
                          className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl ${
                            addHandwash ? 'bg-emerald-500' : 'bg-zinc-100'
                          }`}
                        >
                          🧼
                        </div>
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-zinc-500">
                            Dual sinks with soap and paper towels
                          </p>
                        </div>
                        <div
                          className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                            addHandwash ? 'border-emerald-500 bg-emerald-500' : 'border-zinc-300'
                          }`}
                        >
                          {addHandwash && (
                            <svg
                      ...
                      >
                        ...
                        >
                          <div
                            className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl ${
                              addFencing ? 'bg-emerald-500' : 'bg-zinc-100'
                            }`}
                          >
                            🔗
                          </div>
                          ...
                          <div
                            className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                              addFencing ? 'border-emerald-500 bg-emerald-500' : 'border-zinc-300'
                            }`}
                          >
                            {addFencing && (
                              <svg
                      ...
                      {(eventType === 'wedding' || eventType === 'corporate') && (
                        ...
                        >
                          <div
                            className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl ${
                              addAttendant ? 'bg-emerald-500' : 'bg-zinc-100'
                            }`}
                          >
                            👤
                          </div>
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-zinc-500">
                              Professional service for premium events
                            </p>
                          </div>
                          <div
                            className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                              addAttendant ? 'border-emerald-500 bg-emerald-500' : 'border-zinc-300'
                            }`}
                          >
                            {addAttendant && (
                              <svg
                ...
                {currentStep === 5 && (
                  ...
                  >
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <p className="text-zinc-500">
                          Based on your{' '}
                          {eventTypeOptions.find((e) => e.value === eventType)?.label || 'event'}{' '}
                          requirements
                        </p>
                      </div>
                      <button
                    ...
                    <div className="bg-gradient-to-br from-sky-600 to-sky-700 rounded-3xl p-6 text-white mb-6">
                      <p className="text-sky-200 text-sm font-bold uppercase tracking-widest mb-4">
                        ✓ Recommended Setup
                      </p>
                    ...
                    <p className="text-center text-sm text-zinc-500 mt-6">
                      This is an estimate based on industry standards. Our team will confirm final
                      requirements.
                    </p>
                  </motion.div>
                )}
