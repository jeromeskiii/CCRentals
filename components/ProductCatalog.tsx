      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-2xl">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-zinc-900 tracking-tight">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product) => (
            <div
              key={product.id}
              className="group bg-zinc-50 rounded-3xl overflow-hidden border border-zinc-200 hover:shadow-2xl hover:-translate-y-1 transition-all duration-500"
            >
